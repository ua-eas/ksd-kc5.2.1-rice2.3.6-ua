...
public final class KRADConstants {
	...
	/**
	 * Constant defined to match with method call in module-locked.jsp which is set to a message that is displayed when
	 ...
	 * maxLength has not been defined in the DD
	 */
	public static final String RESULTS_DEFAULT_MAX_COLUMN_LENGTH = "RESULTS_DEFAULT_MAX_COLUMN_LENGTH";

	// /**
	// * The number of levels BusinessObjectDictionaryServiceImpl will recurse. If this number is high, it may lead to
	// serious
	 ...
	 * with the checkbox's name suffixed with the value of this constant. No real fields should have names that contain
	 * this suffix, since this may lead to undesired results.
	 */
	...
	// public static final String DOCUMENT_ERRORS_LESS_DOCUMENT = DOCUMENT_EXPLANATION_ERRORS + "," +
	// DOCUMENT_REVERSAL_ERRORS + "," + DOCUMENT_SELECTED_ERRORS + "," + DOCUMENT_HEADER_ERRORS;
	...
	public static final class SystemGroupParameterNames {
		...
		// public static final String MULTIPLE_VALUE_LOOKUP_RESULTS_EXPIRATION_AGE =
